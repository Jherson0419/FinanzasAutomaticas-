plugins {
    ...
    // Fase 71: lee android/app/google-services.json y genera los recursos
    // que firebase_core necesita en tiempo de build — sin este plugin,
    // Firebase.initializeApp() falla en Android aunque el JSON exista.
